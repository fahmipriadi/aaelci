...
$kodeup=$_SESSION['kodeup'];		/*--->>>>>   kalau eror logout dl baru login lagi */

if ($kodeup == null) {
  echo "Tidak bisa menampilkan data karena sesi anda sudah habis <br> Silahkan login kembali melalui <a href='http://10.30.1.21/aaelci'>link ini</a>"; 
  exit();
  }
...
$Qry="select idpel, nmplg, alamatplg, kodeup, goltarif, daya, statusplg, jenis_mutasi, thblmut from dil
    where kodeup = $kodeup and idpel in( select idpel from cust_ail where tgl_update is null) 

...
echo "<form name=\"lap_pdp\" method=\"post\" action=\"laporan_pdp_refresh.php\" >";
...
$Qry="select kode_ap,uarea,sarea from t_area order by kode_ap";
$stm=oci_parse($cn,$Qry);
oci_execute($stm);
while ($hasil=oci_fetch_array($stm,OCI_BOTH)){
  $tunjuk="laporan_pdp_".$hasil[2].".php";
  echo "<table border=1 width=100%><tr>";
  echo "<td width=25% align=\"LEFT\"><font size=3><a href=\"$tunjuk\">*** Area $hasil[1]</a></font></td>\n";

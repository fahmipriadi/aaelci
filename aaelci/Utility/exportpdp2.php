...
echo chr(34).$data[12].chr(34).$delimiterku;
echo chr(34).$data[13].chr(34).$delimiterku;
echo chr(34).$data[14].chr(34).$delimiterku;
echo chr(34).$data[15].chr(34).$delimiterku;
echo chr(13);
}
//echo "</table>\n";

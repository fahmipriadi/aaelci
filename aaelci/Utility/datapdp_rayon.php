...
<p><a href="exportpdp_rayon1.php?awal=<?php echo $awal?>&akhir=<?php echo $akhir?>"><button>Export CSV Office 2007</button></a></p>
<p><a href="exportpdp_rayon2.php?awal=<?php echo $awal?>&akhir=<?php echo $akhir?>"><button>Export CSV Office 2010 ke atas</button></a></p>
<?php
} //end IF
?>	

<form action="datapdp_rayon.php" method="get">
...
<td width=10% align="CENTER"><font size=1>KODE_UPI</font></td>
<td width=10% align="CENTER"><font size=1>KODE_AP</font></td>
<td width=6%  align="CENTER"><font size=1>KODEUP</font></td>
<td width=6%  align="CENTER"><font size=1>PRD_PLAN</font></td>
<td width=6%  align="CENTER"><font size=1>TARGET</font></td>
<td width=10% align="CENTER"><font size=1>REAL 1</font></td>
<td width=10% align="CENTER"><font size=1>REAL 2</font></td>
<td width=10% align="CENTER"><font size=1>REAL 3</font></td>
<td width=10% align="CENTER"><font size=1>REAL 4</font></td>
<td width=10% align="CENTER"><font size=1>REAL 5</font></td>
</tr>
...
$Qry="SELECT * FROM SNAPSHOT_PDP_RAYON where tanggal between to_date ('$awal','MM/DD/YYYY') and to_date ('$akhir','MM/DD/YYYY') order by TANGGAL";
//ECHO $Qry;
//exit();	

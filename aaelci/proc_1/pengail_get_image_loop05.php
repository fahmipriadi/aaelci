...
$myfile = fopen(date('Y-m-d_H_i_s')."cek_loop_gambar_limit10.txt", "w") or die("Unable to open file!");
...
if ($img !== false)
{
		...
		//BUAT TABEL BARU
		$Qry02="INSERT INTO IMG_TELAH_DI_CEK (IDPEL, KODE_IMG, NO_IMG) VALUES ('".$brs['IDPEL']."','".$brs['KODE_IMG']."','".$brs['NO_IMG']."')";

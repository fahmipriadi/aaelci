...
$Qry="select * from v_ail_rak_12345 where kodeup='$kdunit' and ail_lemari='$lemari' 
and ail_baris='$brs' and ail_kolom='$klm' order by kodeup,ail_lemari,ail_baris,ail_kolom,ail_nomor";
//$stm=odbc_do($cn,$Qry);
$stm=oci_parse($cn,$Qry);
oci_execute($stm);
...
$nmfile=$kdunit.'_pdp_i_ii_002_'.$lemari.$brs.$klm.'.xls';
...
$worksheet->write(3, 1, 'DAFTAR ISI RAK PENYIMPANAN AIL',$format_judul);
$worksheet->write(4, 1, 'PDP I.II-002',$format_judul);

...
$Qry="select * from v_ail_rak where kodeup='$kdunit' 
and nip>=$mulai and nip<=$prdlap order by idpel " ;
...
$nmfile=$kdunit.'_pdp_i_ii_003.xls';
$workbook->send($nmfile);

// Creating a worksheet
$nama_ws="PDP I.II-003(".$prdlap.")";
...
$worksheet->write(9, 1, 'RENTANG IDPEL',$format_header);
$worksheet->write(9, 4, $range,$format_header);

$worksheet->write(3, 1, 'DAFTAR AIL TERSIMPAN',$format_judul);
$worksheet->write(4, 1, 'PDP I.II-003',$format_judul);

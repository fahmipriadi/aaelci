...
$node4_4 = &$node4->addItem(new HTML_TreeNode(array('text' => "Kertas Kerja Verifikasi Fisik", 'link' => "menu_alert1.php", 'icon' => $icon, 'expandedIcon' => $expandedIcon,'linkTarget' => "menu_show")));
...
$node5_5 = &$node5->addItem(new HTML_TreeNode(array('text' => "Kertas Kerja Pembenahan Data ", 'link' => "menu_alert1.php", 'icon' => $icon, 'expandedIcon' => $expandedIcon,'linkTarget' => "menu_show")));
...
$node6_4 = &$node6->addItem(new HTML_TreeNode(array('text' => "Edit Kode Image AIL", 'link' => "menu_alert.php", 'icon' => $icon, 'expandedIcon' => $expandedIcon, 'linkTarget' => "menu_show")));
$node6_4_1 = &$node6_4->addItem(new HTML_TreeNode(array('text' => "Edit Kode Image", 'link' => "../utility/pengail_edit_pos_image_frame.php", 'icon' => $icon, 'expandedIcon' => $expandedIcon,'linkTarget' => "menu_show")));
    
$node6_4_2 = &$node6_4->addItem(new HTML_TreeNode(array('text' => "Delete Image Gagal Upload", 'link' => "menu_alert1.php", 'icon' => $icon, 'expandedIcon' => $expandedIcon,'linkTarget' => "menu_show")));
    
$node6_4_3 = &$node6_4->addItem(new HTML_TreeNode(array('text' => "Delete Image", 'link' => "menu_alert1.php", 'icon' => $icon, 'expandedIcon' => $expandedIcon,'linkTarget' => "menu_show")));
